...
== My fork includes
* Active Admin styles are no longer wrapped with .active_admin and therefore they don't take precedence over any third party styling. So CKeditor now looks like CKeditor, etc...
